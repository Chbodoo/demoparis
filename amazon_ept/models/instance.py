...
#     amazon_browse_node_ids = fields.One2many('amazon.browse.node.ept', 'instance_id', string='Categories')        
    ...
    amazon_sale_order_ids = fields.One2many('sale.order', 'amz_instance_id', string='Orders')
    ...
    quotation_ids = fields.One2many('sale.order','amz_instance_id',domain=[('state','in',['draft','sent'])],string="Quotations")        
