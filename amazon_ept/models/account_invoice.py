...
class account_invoice(models.Model):
    ...
    def action_move_create(self):
        ...
        for record in self : 
            record.move_id.seller_id = record.seller_id and record.seller_id.id or False
            record.move_id.amazon_instance_id = record.amazon_instance_id and record.amazon_instance_id.id or False
            for line in record.move_id.line_ids:
                line.seller_id = record.seller_id and record.seller_id.id or False         
                line.amazon_instance_id = record.amazon_instance_id and record.amazon_instance_id.id or False
        return result
